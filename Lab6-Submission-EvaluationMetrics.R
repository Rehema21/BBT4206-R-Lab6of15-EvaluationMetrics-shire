...
library(readr)
breast_cancer_wisconsin_data_data <- read_csv("data/breast-cancer-wisconsin-data_data.csv")
View(breast_cancer_wisconsin_data_data)
...
data(breast_cancer_wisconsin_data_data)
